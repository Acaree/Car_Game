...
# Welcome to this circuit that haves a lot of curves and multiple obstacles. You have to do 3 laps in the less than 7,5 minutes if not, you will return to the finish line from the begining (yes, in the first lap with time 0), there are checkpoints during the circuit in case you fall or if you get stuck. Good luck!

# Controls
Up/down arrows -> move forward/backwards
Right/Left -> turn right/left
Right control -> respawn to the latest checkpoint
